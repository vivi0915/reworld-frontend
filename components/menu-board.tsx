...
const groups = [
  { role: "法師", code: "AP", color: "#23a7ff" },
  { role: "射手", code: "AD", color: "#16e0bc" },
  { role: "戰士", code: "Top", color: "#ff7048" },
  { role: "打野", code: "Jungle", color: "#a861ff" },
];
...
export function MenuBoard() {
  ...
  const [message, setMessage] = useState("從法師 1 出發，也可以直接點選菜單格。");
  ...
  return <div className="screen menu-screen">
    ...
    <p className="demo-note">四種屬性 × 各三杯 · 酒名與價格待確認</p>
