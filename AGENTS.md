...
- Preserve applied migrations and production data. The current Sites deployment has a private administrator provisioning migration 0003 not included here; coordinate future migration numbering (0004 onward) when updating that deployment.
